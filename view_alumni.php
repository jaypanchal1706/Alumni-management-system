...
<?php
if(isset($_GET['id'])){
$qry = $conn->query("SELECT a.*,mobile,c.course,Concat(a.lastname,', ',a.firstname,' ',a.middlename) as name from alumnus_bio a inner join courses c on c.id = a.course_id where a.id= ".$_GET['id']);
	...
	<div class="col-lg-12">
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<p>Mobile: <b><?php echo $mobile ?></b></p>
			</div>
		</div>
	</div>
</div>
